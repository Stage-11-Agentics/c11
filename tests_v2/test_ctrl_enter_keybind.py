...
def infer_app_name_for_osascript(socket_path: str) -> str:
    ...
    Examples:
      - /tmp/cmux-debug.sock          -> "c11 DEV"
      - /tmp/cmux-debug-foo.sock      -> "c11 DEV foo"
      - ~/Library/Application Support/c11mux/cmux.sock -> "c11"
      - /tmp/cmux-foo.sock            -> "c11 foo"
    """
