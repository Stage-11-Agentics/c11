...
**Whenever you edit any installable skill** (the list lives in `skills/MANIFEST.json` — c11 and its peers, `lattice-orchestrator`, the `overture-*` stages, `venture-partner`), the change is not done until you run:
